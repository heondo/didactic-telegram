...
const MeridianDetailsPointsListScreenComponent = ({
  navigation,
  theme,
  route,
}) => {
...
export const MeridianDetailsPointsListScreen = connect(mapStateToProps)(
  MeridianDetailsPointsListScreenComponent,
)
